...
import { List, Box, CircularProgress, Typography, TextField, Button, Pagination } from '@mui/material';
...
const ModelList = ({ data = [], loading }) => {
    ...
    const filteredItems = data.filter((item) =>
        item.name?.toLowerCase().includes(searchTerm.toLowerCase()) // Assuming 'name' is the searchable field
    );
    ...
    return (
        ...
        >
            ...
            >
                ...
                {filteredItems.length > itemsPerPage ?<Box sx={{ display: 'flex', justifyContent: 'flex-end', mt: 1 }}>
                     <Pagination
