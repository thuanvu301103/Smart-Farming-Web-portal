...
import ScriptInfoPanel from '../../script/newScript/ScriptInfoPanel';
import PrivacyPanel from '../../script/newScript/PrivacyPanel';
...
const NewScriptModel = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const scriptId = await modelApi.createScriptModel(userId, modelId, formData);
            handleSubmitFile(userId, scriptId)
